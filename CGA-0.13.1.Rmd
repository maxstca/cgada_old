...
author: "Versions 0.13.1 and 0.13.2"
output: 
  html_document:
    toc: true
    toc_float: true
...
# Read in data
setwd("data_old")
october5 <- read_in_data("v0_13_1_d10_05_2025.csv", "10/05/2025", "0.13.1", TRUE)
october19 <- read_in_data("v0_13_1_d10_19_2025.csv", "10/19/2025", "0.13.1", TRUE)
november2 <- read_in_data("v0_13_2_d11_02_2025.csv", "11/02/2025", "0.13.2", TRUE)
november16 <- read_in_data("v0_13_2_d11_16_2025.csv", "11/16/2025", "0.13.2", TRUE)
november30 <- read_in_data("v0_13_2_d11_30_2025.csv", "11/30/2025", "0.13.2", TRUE)

#Merge obs. into one set of data
dflist <- list(october5, october19, november2, november16, november30)
...
A total of `r length(cgada$ID)` lives were played across `r length(dflist)` playtests. Thank you to all who participated!
...
suppressMessages(
  ...
  theme(legend.position = "none") +
  annotate(geom = "text", x = 0.53, y = 24.5, label = "Coin-specialized", color = "black", alpha = 0.4) +
  annotate(geom = "text", x = 1.1, y = 24.5, label = "High Event", color = "black", alpha = 0.4) +
  annotate(geom = "text", x = 0.53, y = 11, label = "Low Event", color = "black", alpha = 0.4) +
  annotate(geom = "text", x = 1.1, y = 11, label = "Kill-specialized", color = "black", alpha = 0.4) +
